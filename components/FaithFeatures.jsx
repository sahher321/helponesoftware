                ...
                <div className="grid md:grid-cols-12 gap-12 md:gap-20 items-start">
                    ...
                    <div data-aos="fade-left" className="md:col-span-7 lg:col-span-7">
                        <p className="text-lg md:text-xl text-white/80 leading-relaxed mb-12">
                            From Sunday services to midweek small groups, HelpOne removes the admin burden so your leaders can focus on discipleship, prayer, and reaching the lost. Unlimited everything. One flat price. No per-record fees.
                        </p>
