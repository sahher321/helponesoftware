        ...
        <section className="py-24 bg-[#050914] text-white">
            <div className="max-w-4xl mx-auto px-6 text-center">
                <div className="mb-8">
                    ...
                    <h2 className="heading-font text-5xl md:text-6xl font-bold tracking-tighter mb-6">
                        Founders Program
                    </h2>
                ...
                <div className="bg-[#0A1428] rounded-3xl p-10 md:p-14 border border-white/10 max-w-2xl mx-auto shadow-2xl">
                    ...
                    <Link href="/contact-us" className="inline-block text-center w-full bg-white text-[#0A1428] text-lg font-bold py-5 rounded-xl hover:bg-[#00E6C3] transition-colors shadow-lg">
