...
export const metadata = {
    title: 'Privacy Policy | HelpOne Software',
    description: 'Read the Privacy Policy for HelpOne Software. Last updated February 25, 2026.',
    alternates: { canonical: 'https://helponesoftware.com/privacy-policy/' },
};
...
const sections = [
    {
        ...
        content: (
            <div className="space-y-3 text-white/70 text-sm md:text-base leading-relaxed">
                ...
                <p>
                    This web page represents a legal document and is the Privacy Policy for our website,{' '}
